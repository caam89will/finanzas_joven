      ...
      >
        {type === 'textarea' ? (
          ...
          <input
            type={type}
            className={cn(
            `shadow-input dark:placeholder-text-neutral-400 flex h-10 w-full rounded-md border-none bg-gray-50 px-3 py-2 text-sm text-black transition duration-400 group-hover/input:shadow-none file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-neutral-400 focus-visible:ring-[2px] focus-visible:ring-blue-500 focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50 dark:bg-zinc-800/80 dark:text-white dark:shadow-[0px_0px_1px_1px_#404040] dark:focus-visible:ring-blue-500 backdrop-blur-sm`,
              className
            )}
            ref={ref}
            {...props}
  ...
  const validateForm = (event) => {
    ...
    fields.forEach((field) => {
      ...
      if (field.required && !value) {
        currentErrors[field.label] = `${field.label} es requerido`;
      }
  ...
  return (
    <section className='max-md:w-full flex flex-col gap-4 w-96 mx-auto'>
      <BoxReveal boxColor='var(--skeleton)' duration={0.3}>
        <h2 className='font-bold text-3xl text-neutral-800 dark:text-white'>
          {header}
        </h2>
      </BoxReveal>
